...
impact: "6 UX findings documented; authentication cascade across 3 domains mapped; 10-slide presentation deck produced; meeting script written for 25-minute client session; all findings hypothesis-framed for [redacted] audience"
---
...
**The brief from the client:** Analyze the four pages and propose UX improvements. Deliverable: a meeting presentation for the client stakeholders during a visit to [redacted].
...
Conducted an analytics-driven UX audit from screenshots; identified a cross-platform authentication cascade that was invisible in any individual analytics report; structured findings as testable hypotheses rather than prescriptions, calibrated for an [redacted]/German/Brazilian stakeholder audience.
...
- **Content Designer / UX Writer**: Wrote the meeting script (hypothesis-framing, data walkthrough, slide transition cues, 3 strategic questions) and slide specifications for the presenter to deliver in [redacted].
...
A ~25-minute meeting script was written for the presenter — not a slide outline, but a presenter guide with hypothesis framing, data walkthrough narration, slide transition cues, and speaker notes. The tone was calibrated: light but direct, suitable for an [redacted]/German/Brazilian stakeholder mix. The 11-slide deck was specified frame by frame (layout type, headline, body copy, screenshot reference, Figma implementation notes, speaker notes).
...
- `meeting-script.md` — ~25-minute presenter guide for [redacted] stakeholder meeting; includes slide transition cues, hypothesis framing, data walkthrough narration, speaker notes for three strategic questions
...
- `[redacted]_Website_A_UX_Perspective.pptx` / `.pdf` — Completed 10-slide presentation deck; sent to presenter for [redacted] review

**Outcomes:**
- Deck approved and used in the [redacted] client presentation.
